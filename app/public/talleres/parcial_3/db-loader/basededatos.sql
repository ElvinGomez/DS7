...
insert into `user`(`codusuario`,`usuario`,`contrasena`,`nombre`,`apellido`, `profile_picture`) values 
(1,'test','123123123','Juan','Perez', 'https://randomuser.me/api/portraits/men/61.jpg');
